    ...
    return (
        <section className="relative flex-col justify-center items-center w-full bg-white p-2">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className='flex flex-col justify-center items-center text-center '>
                <div className="shorten absolute -bottom-[11rem] w-screen max-w-sm bg-primary-dark-violet rounded-lg flex flex-col justify-start mb-20 items-center p-6 text-center z-50 sm:max-w-md md:max-w-lg lg:max-w-xl xl:max-w-2xl sm:-bottom-[9rem] sm:flex-row sm:space-x-8">
