...
function Features(){
    return(
        <section className=" relative grid grid-cols-1 z-50 gap-[8rem]  sm:mb-20 lg:mb-40 grid-rows-auto place-items-center text-center w-full h-auto bg-[#F2F2F2]  sm:p-5 sm:gap-10 ">
            ...
            <div className='relative grid grid-cols-1 z-50 gap-[8rem] lg:gap-4 xl:gap-0 grid-rows-auto place-items-center text-center w-full sm:gap-10 h-auto bg-[#F2F2F2]  sm:grid-cols-3 sm:grid-rows-1'>
